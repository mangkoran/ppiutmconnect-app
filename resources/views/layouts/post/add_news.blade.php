          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select name="news_category" class="form-control" @if (isset($newsDesc['isView'])) disabled @endif required>
                    ...
                    <option value="Social & Public"@isset($newsDesc['news']) @if($newsDesc['news']['news_category'] == "Social & Public")
                      selected
              ...
              <div class="form-group row">
                ...
                @if (isset($newsDesc['isView']))
                <img src="{{ asset('images/news/' . $newsDesc['news']->news_id . '/' . $newsDesc['news']->news_pic1) }}" alt="">
                @else
                <div class="col-sm-9">
